  ...
  return (
    ...
    >
      <div className="relative w-full">
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto scroll-smooth py-2 [scrollbar-width:none] md:py-8"
          ref={carouselRef}
        ...
        >
          ...
          <div
            className={
              "mx-auto mr-8 flex max-w-xl flex-row justify-start gap-4 pl-4 pr-0"
            }
          >
